...
public class MViewPrinterProvider {
    ...
    public void showFloatingView(){
        ...
        params.bottomMargin = MDisplayUtil.dp2px(100,recyclerView.getResources());
    ...
    private void showLogView() {
        ...
        FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, MDisplayUtil.dp2px(160,rootView.getResources()));
